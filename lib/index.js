...
function Makitso(args) {
  ...
  return {
    ...
    start() {
      ...
      return cmd({ context, appCommands: commands, options }).catch(
        console.error
      );
    }
  };
...
// added for a reason.. when I realise what that was, can look at it again
// It prevents the tests from stopping after they're done though.
// adding process.stdin.pause(); to the quit handler resolves this..
